<?php
require_once ('config2.php'); // For storing username and password.
...
<div class="container">
    <form action="" method="post" name="Login_Form" class="form-signin">
        ...
        <label for="inputPassword" class="sr-only">Password</label> <!-- price -->
        <input name="Password" type="submit" id="inputPassword" class="form-control" placeholder="Password" required>
        <div class="checkbox">
         </div>
