<?php
require_once ('config1.php'); // For storing username and password.
...
<div class="container">
    <form action="" method="post" name="Login_Form" class="form-signin">
        ...
        <label for="inputUsername" class="sr-only">Username</label>  <!-- GameOfThrones -->

        <input name="Username" type="username" id="inputUsername" class="form-control" placeholder="Username" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>  <!-- sansa -->
